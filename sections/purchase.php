                    ...
                    <div class="col-12 px-0 m-0">
                        ...
                        <div class="col-12 mb-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 px-0">
                                        <input type="text" name="purchase_surname" class="choose-option-add mx-3" placeholder="Sotib oluvchi familiyasi">
                                        <input type="text" name="purchase_tel" class="choose-option-add mx-3 mt-3" placeholder="Telefon">
                                        <input type="text" name="purchase_price" class="choose-option-add mt-3 mx-3" placeholder="Narx">
                                    </div>

                                    <div class="col-12 mt-3 px-0">
                                        <input class="choose-option-add-textarea" name="purchase_comment" type="textarea" placeholder="Komment">
                                    </div>
                                </div>
                                <!-- end row -->
                        </div>
