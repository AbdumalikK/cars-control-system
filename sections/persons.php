                                    ...
                                    <div class="col-12 px-0">
                                     ...
                                     <div class="content-border mb-2">
                                          <div class="row mb-2">
                                             ...
                                             <div class="col-4">
                                              <input class="choose-option-add" name="person_surname" placeholder="Familiya" id="marka" required>
                                             <input type="text" name="person_tel1" class="choose-option-add mt-3" placeholder="Telefon 1" required>
                                             <input type="text" name="person_tel2" class="choose-option-add mt-3" placeholder="Telefon 2">
                                             </div>
                                             ...
                                             <div class="col-2">
                                                 <div class="file-input">
                                                   ...
                                                   <img src="" class="top-0" id="img-show" alt="">
                                             </div>
                                        ...
                                        <input class="choose-option-add" name="respons_name" placeholder="Javobgar shaxs ismi" id="marka" required>
                                         <input class="choose-option-add mt-3" name="respons_fathername" placeholder="Otasining ismi" id="marka" required>
                                          ...
                                          <div class="col-4">
                                          <input class="choose-option-add" name="respons_surname" placeholder="Familiya" id="marka" required>
                                          <input type="text" name="respons_tel1" class="choose-option-add mt-3" placeholder="Telefon 1" required>
                                          <input type="text" name="respons_tel2" class="choose-option-add mt-3" placeholder="Telefon 2">
                                          </div>
                                          ...
                                          <div class="col-2">
                                              <div class="file-input mt-1">
                                                ...
                                                <img src="" class="top-0" id="img-show1" alt="">
                                          </div>
