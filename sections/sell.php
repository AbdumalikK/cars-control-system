                        ...
                        <div class="col-12 mb-2">
                                ...
                                <div class="row">
                                    <div class="col-6 px-0">
                                        <input type="text" name="sale_respons_name" class="choose-option-add mx-1" placeholder="Javobgar ismi">
                                    ...
                                    <div class="col-12 mt-3 px-0">
                                        <input class="choose-option-add-textarea" type="textarea" name="sale_comment" placeholder="Komment">
                                    </div>
                                </div>
                                <!-- end row -->
                        </div>
